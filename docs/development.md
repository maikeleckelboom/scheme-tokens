...
`pnpm release:check` adds package checks, packed root consumer smoke, a packed theme-coordinate consumer, tarball checks, docs-site checks, docs example checks, and an external packed-consumer audit.
